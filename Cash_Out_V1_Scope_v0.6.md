...
![Version](https://img.shields.io/badge/version-v0.6-blue) ![Status](https://img.shields.io/badge/status-Draft-orange) ![Date](https://img.shields.io/badge/date-2026--04--27-lightgrey) ![Module](https://img.shields.io/badge/module-Sportsbook%20Core-informational)

| Program Owner | Date | Version | Status |
|:---|:---|:---|:---|
| _To be assigned_ | 27 Apr 2026 | v0.6 | Draft |
...
Punters with open Bets currently have no way to lock in a partial return before the market is settled. They watch a winning position drift back to neutral, or absorb the full loss on a losing position, with no exit. Customer feedback consistently flags Cash Out as the single most-requested missing feature, and Punters churning to competitors cite "couldn't cash out" as a top-3 reason. The friction applies equally to Bets placed long before the event and Bets placed during the event — and equally to Punters who want to settle the whole stake, only part of it, or have it auto-settle at a target value.
...
- Trading workflow — VigRate Table calibration, exception list management, per-punter disable, and liability reporting
...
| Engineering — Trading Tooling | 🟡 Pending | Sport / league / event / market hierarchical enable; per-punter disable flag; VigRate Table maintenance UI |
...
#### 🎬 Use Case 2: Full Cash Out — Settle When the Price Has Moved in Punter's Favour

| | |
|:---|:---|
| **👤 Actor** | Punter with an open Bet on an enabled market, where the market price has moved to favour their selection |
| **🎯 Goal** | Lock in a partial return that reflects the favourable price move, minus the uplift the platform retains |
...
#### 🎬 Use Case 10: Trading Disables Cash Out for a Specific Punter
...
#### 🎬 Use Case 11: Trading Configures a Sport / League / Event / Market Enablement
