...
- 📈 **Handle lift on enabled sports / leagues** — driven by retention of pending wagers and reduced abandonment 
...
> 🎯 **Customer Retention & Competitive Parity** — one of the largest product gap vs major competitors and unlock retention engagement on long-tenor pending Bets.
...
> **Rule applied:** Trading, Risk, Finance, and CS are listed (PRINCIPLE 8). Analytics is listed because new transaction and metric categories are introduced. 
